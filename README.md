...
## 9. Файлы
Копия корневой директории `airflow_docker` есть в списке файлов данного репозитория с уже исправленными/добавленными файлами и библиотеками. После скачивания архива нужно:
