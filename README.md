...
* VSCode (https://code.visualstudio.com/, я использовал его) / PyCharm (https://www.jetbrains.com/ru-ru/pycharm/), Docker (см. ниже),
* предустановленный Python (https://www.python.org/).
