...
<p align="center">
  <img width="750" height="490" src="https://github.com/SvgPrizrak/Apache_Airflow_Guide/blob/main/pictures/databases_configuration.png">
</p>
...
Расположение БД выглядит после настройки подключений следующим образом - можно переходить к следующим пунктам.
<p align="center">
  <img width="1400" height="490" src="https://github.com/SvgPrizrak/Apache_Airflow_Guide/blob/main/pictures/Airflow_connections.png">
</p>
